...
from GestionClaves.views import login, token, formulario_registro, pagina, logout, formulario_credenciales, ListaAsociados, compartir, llavePublica
...
urlpatterns = [
    ...
    path('llavePublica',  llavePublica),
]
